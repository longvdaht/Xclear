...
class MeowKit_MFRH_Rest {
  private $namespace = 'meow-common/v1';
  public static $instance = null;

  public static function init_once() {
    if ( !MeowKit_MFRH_Rest::$instance ) {
      MeowKit_MFRH_Rest::$instance = new self();
    }
  }
  ...
  public function rest_error_logs( $request ) {
    return new WP_REST_Response( [ 'success' => true, 'data' => MeowKit_MFRH_Helpers::php_error_logs() ], 200 );
  }
